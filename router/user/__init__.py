...
from .get_user_byId import get_user_byId_bp
from .validation import validate_bp

# Create a main blueprint for all user routes
user_bp: Blueprint = Blueprint("user_bp", __name__, url_prefix="/users")
